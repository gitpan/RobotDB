package WWW::RobotRules::RobotDB;
BEGIN{
use 5.008008;
use strict;
use warnings;
...
=head1 NAME
	...
	robotDB - Perl extension for maintaining a robots.txt in a MySQL database

=head1 SYNOPSIS

  use robotDB;
  
  my $rulesDB = robotDB->new($host,$username,$password,$database);
